...
def predict(start_date: str,
    ...
    """
    # !!! YOUR CODE HERE !!!
    preds_df = predict_df(start_date, end_date, path_to_ips_file, verbose=False, NB_LOOKBACK_DAYS=nb_lookback_days, rolling=rolling, transform=transform, fs=fs, static=static)
...
def predict_df(start_date_str: str, end_date_str: str, path_to_ips_file: str, verbose=False, NB_LOOKBACK_DAYS = 30, rolling=False, transform=False, fs=False, static=False):
    """
